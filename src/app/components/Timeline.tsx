...
const events: Event[] = [
...

  {
    ...
    desc: "Attended MATLAB / Simulink workshop by MathWorks.",
    certs: [{ title: "MathWorks Workshop", file: "/assets/certs/mathwork.png" }],
  },

  {
    year: "2025",
    title: "Finished CS50x & CS50P",
    desc: "Completed Harvard’s CS50x and CS50P online courses.",
    certs: [
      { title: "CS50x Certificate", file: "/assets/certs/CS50xfinal.png" },
      { title: "CS50P Certificate", file: "/assets/certs/cs50p.png" },
    ],
  },

  {
    year: "2025",
    title: "Completed C++ (Udemy)",
    desc: "Learned C++ via Udemy course.",
    certs: [{ title: "C++ Certificate", file: "/assets/certs/C++.jpg" }],
  },

  {
    year: "2025",
    title: "IET Student Member",
    desc: "Became a student member of the Institution of Engineering and Technology.",
    certs: [{ title: "IET Membership", file: "/assets/certs/iet.png" }],
  },

  {
    year: "2025",
    title: "Started to dive deep in ML",
    desc: "Learning ML and also hardware.",
  },

  {
    year: "2025",
    title: "Finished Introduction to Cybersecurity (Cisco)",
    desc: "Completed Cisco cybersecurity course as part of an assignment.",
    certs: [{ title: "Completion Certificate", file: "/assets/certs/cypython-1.png" }],
  },

  {
    year: "2025",
    title: "Creating a Research Paper (IEEE Access)",
    desc: "Worked on ECG prediction using different ML models.",
    certs: [{ title: "IEEE Access Paper", file: "/pdfs/IEEE Access Paper.pdf" }], // ✅ PDF
  },
]
                ...
                {selected.certs.map((c, i) => {
                  ...
                  return (
                    <div key={i}>
                      ...
                      {isPDF ? (
                        <button
                          className="w-full px-3 py-2 text-xs bg-yellow-300 border-4 border-black rounded-sm hover:bg-yellow-200"
